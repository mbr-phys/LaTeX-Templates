...
\begin{itemize}[nosep]
    ...
    \item Now we have opened a new environment within the table environment, tabular. 
        ...
        \begin{itemize}[nosep,label=\ding{229}]
            ...
            \item The letters themselves indicating the text alignment of the column: `l' represents left alignment, as you can see in the first column of the table, so everything is aligned to the left; `c' represents center alignment, as I've done with the other columns in the table. 
            ...
            \item At the end of each row, we use \lstinline!\\! to indicate we are moving to a new row, and then we can continue this pattern for as many rows as our table needs - we saw this before to make a new lign in the align environment for maths.  
...
\begin{description}[align=right,labelwidth=3cm]
    ...
    \item[\colorbox{lightgray}{hyperref}] hyperlink management 
